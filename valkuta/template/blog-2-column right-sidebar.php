<?php
/**
 * Template Name: Blog 2 Column Right Sidebar
 */
...
<div id="primary" class="content-area layout-grid-rs">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="row all-posts-wrapper">
					...
					if ( $wp_query->have_posts() ) :
						...
						while ( $wp_query->have_posts() ) :
                            ...
                            <div class="single-post-item grid-post-item col-lg-6 col-md-6 col-sm-12">
