<?php
if ( get_post_meta( $post->ID, 'valkuta_video_post_format_meta', true ) ) {
	$video_meta = get_post_meta( $post->ID, 'valkuta_video_post_format_meta', true );
} else {
	$video_meta = array();
}
    ...
    <div class="post-thumbnail-wrapper">
		...
		<?php if ( $video_url ): ?>
            <div class="post-video-button-wrapper">
                <a href="<?php echo esc_url( $video_url ); ?>" class="td_video_button mfp-iframe">
