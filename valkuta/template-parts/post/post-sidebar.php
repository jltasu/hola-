<?php
if(is_archive()){
	$page_layout = valkuta_option('archive_layout', 'right-sidebar');
}else if(is_search()){
	$page_layout = valkuta_option('search_layout', 'right-sidebar');
}else{
	$page_layout = valkuta_option('blog_layout', 'right-sidebar');
}
