...
if ( array_key_exists( 'layout_meta', $common_meta ) && $common_meta['layout_meta'] != 'default' ) {
	...
	$page_layout = valkuta_option( 'page_default_layout', 'full-width' );
}
...
if ( array_key_exists( 'hide_tile_meta', $common_meta ) ) {
	$hide_page_title = $common_meta['hide_tile_meta'];
} else {
...
<?php endif; ?>
    ...
    <div id="primary" class="content-area layout-<?php echo esc_attr( $page_layout ); ?>">
        <div class="container">
            <div class="row">
